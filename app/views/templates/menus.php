            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="http://localhost/my-project/ORI-MS/public/logout">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <?php foreach ($data['menu'] as $menus) : ?>
                <li class="nav-item"><!-- End Data User Nav -->
                    <a class="nav-link collapsed <?= $menus['menu_id']; ?> <?= $menus['is_parent']; ?>" id="<?= $menus['menu_id']; ?>" href="<?= BASEURL; ?><?= $menus['url']; ?>" data-bs-target="#<?= $menus['menu_id']; ?>" data-bs-toggle="collapse">
                        <i class="bi <?= $menus['bi_icon']; ?>"></i>
                        <span><?= $menus['menu_name']; ?></span>
                        <!-- <i class='bi bi-chevron-down ms-auto'></i> -->
                    </a>
                    <?php if (isset($data[$menus['id']])) { ?>
                        <ul id="<?= $menus['menu_id']; ?>" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                            <?php foreach ($data[$menus['id']] as $menus) : ?>
                                <li class="nav-item">
                                    <a class="nav-link collapsed <?= $menus['menu_id']; ?>" id="<?= $menus['menu_id']; ?>" href="<?= BASEURL; ?><?= $menus['url']; ?>">
                                        <i class="bi <?= $menus['bi_icon']; ?>"></i>
                                        <span><?= $menus['menu_name']; ?></span>
